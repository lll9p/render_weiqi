...
(function(){var a="",e=document.createElement("style");
a+="div.mxClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxCommentDiv{margin:0.5em auto;height:8em;overflow:auto;border:1px solid #999;}"
a+="div.mxClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxCommentContentDiv {padding:0.25em;text-align:justify;}"
a+="div.mxClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxCommentDiv h1 {font-size:1em;text-align:left;margin:0;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
