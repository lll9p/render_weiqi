...
(function(){var a="",e=document.createElement("style");
a+="div.mxRosewoodGlobalBoxDiv.mxDiagramGlobalBoxDiv div.mxNotSeenDiv {text-align:left;margin:0.5em auto;}"
a+="div.mxRosewoodGlobalBoxDiv.mxDiagramGlobalBoxDiv div.mxInNotSeenDiv{white-space:nowrap;display:inline-block;padding:0.1em;}"
a+="div.mxRosewoodGlobalBoxDiv.mxDiagramGlobalBoxDiv div.mxInNotSeenDiv * {vertical-align:middle;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].b[0]={n:"1Box",c:["Diagram","Goban"]};
mxG.D[mxG.K].b[1]={n:"2Box",c:["NotSeen"]};
