...
(function(){var a="",e=document.createElement("style");
a+="div.mxRosewoodGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxCommentDiv {margin:0 auto 0.5em auto;text-align:center;}"
a+="div.mxRosewoodGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxCommentContentDiv {display:inline-block;text-align:justify;}"
a+="div.mxRosewoodGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv {text-align:center;margin-top:0.75em;}"
a+="div.mxRosewoodGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv button{font-family:Arial,sans-serif;font-size:0.875em;height:auto;border:1px solid rgba(0,0,0,0.4);margin:1px;padding:0.25em;color:rgba(0,0,0,0.8);background:transparent;box-shadow:none;}"
a+="div.mxRosewoodGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv button[disabled]{color:rgba(0,0,0,0.4);border:1px solid rgba(0,0,0,0.2);}"
a+="div.mxRosewoodGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv button:hover {cursor:pointer;}"
a+="div.mxRosewoodGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv button[disabled]:hover {cursor:default;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
