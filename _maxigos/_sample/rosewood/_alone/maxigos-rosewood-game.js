...
(function(){var a="",e=document.createElement("style");
a+="div.mxRosewoodGlobalBoxDiv.mxGameGlobalBoxDiv div.mxHeaderDiv{margin:0 auto 0.5em auto;text-align:left;}"
a+="div.mxRosewoodGlobalBoxDiv.mxGameGlobalBoxDiv div.mxHeaderDiv h1{text-align:left;font-size:1em;margin:0;padding:0;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].b[0]={n:"Box",c:["Title","Header","Goban","Navigation","Variations","Version"]};
