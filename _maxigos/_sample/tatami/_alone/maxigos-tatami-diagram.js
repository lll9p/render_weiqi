...
(function(){var a="",e=document.createElement("style");
a+=".mxTatamiGlobalBoxDiv.mxDiagramGlobalBoxDiv div.mxNotSeenBoxDiv {background:#eee;padding:10px 0;}"
a+=".mxTatamiGlobalBoxDiv.mxDiagramGlobalBoxDiv div.mxNotSeenDiv {text-align:left;margin:0 auto;background:#fff;}"
a+=".mxTatamiGlobalBoxDiv.mxDiagramGlobalBoxDiv div.mxInNotSeenDiv {white-space:nowrap;display:inline-block;padding:0.1em;}"
a+=".mxTatamiGlobalBoxDiv.mxDiagramGlobalBoxDiv div.mxInNotSeenDiv * {vertical-align:middle;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].b[0]={n:"GobanBox",c:["Diagram","TatamiCartouche","TatamiWhite","Goban","TatamiBlack"]};
mxG.D[mxG.K].b[1]={n:"NotSeenBox",c:["NotSeen"]};
