...
gp.style.padding="1px "+wws+"px 1px "+wbs+"px"; 
...
if (document.documentElement.clientWidth>360) wa-=16;
...
a+=".mxTatamiGlobalBoxDiv{margin:0 auto;padding:0;display:table;position:relative;font-family:Arial,sans-serif;}"
a+=".mxTatamiGlobalBoxDiv div.mxNavigationBoxDiv{background:#eee;padding:0.5em 0;}"
a+=".mxTatamiGlobalBoxDiv div.mxGobanBoxDiv{background-image:url(data:image/jpg;base64,);text-align:center;position:relative;padding:1px 8px;border:2px solid rgb(220,200,150);}"
a+=".mxTatamiGlobalBoxDiv div.mxGobanDiv{margin:1em auto;position:relative;}"
a+=".mxTatamiGlobalBoxDiv.mxIn3d div.mxInnerGobanDiv{box-shadow:0 0.5em 0.5em #963;}"
a+=".mxTatamiGlobalBoxDiv.mxIn3d div.mxGobanDiv.mxUnder div.mxInnerGobanDiv{box-shadow:none;}"
a+=".mxTatamiGlobalBoxDiv.mxIn2d  div.mxInnerGobanDiv{border:1px solid #dfc997;box-shadow:1px 0 0.5em #dfc997;box-shadow:-1px 0 0.5em #dfc997;box-shadow:0 1px 0.5em #dfc997;box-shadow:0 -1px 0.5em #dfc997;}"
a+=".mxTatamiGlobalBoxDiv div.mxGobanDiv canvas{background:#ecbe69;}"
a+="/* buttons */.mxTatamiGlobalBoxDiv button {-webkit-appearance:none;}"
a+=".mxTatamiGlobalBoxDiv button{cursor:pointer;margin:2px;padding:0.2em 0.3em;border:0;border-radius:0;box-shadow:none;color:#000;background:#fff;height:2em;font-size:1em;vertical-align:middle;}"
a+=".mxTatamiGlobalBoxDiv.mxIn3d button{box-shadow:0 0.125em 0.125em #666;}"
a+=".mxTatamiGlobalBoxDiv.mxIn2d button{border:1px solid #ccc;}"
a+=".mxTatamiGlobalBoxDiv button:hover {cursor:pointer;}"
a+=".mxTatamiGlobalBoxDiv button[disabled]:hover {cursor:default;}"
a+="/* Bowls */.mxTatamiGlobalBoxDiv div.mxBlackStonesDiv{position:absolute;bottom:0;right:0;}"
a+=".mxTatamiGlobalBoxDiv div.mxWhiteStonesDiv{position:absolute;top:0;left:0;}"
a+=".mxTatamiGlobalBoxDiv .mxBowlCanvas,.mxTatamiGlobalBoxDiv .mxCapCanvas{display:block;margin:0 auto;}"
a+="/* version */.mxTatamiGlobalBoxDiv div.mxVersionDiv{font-size:0.75em;color:#999;text-align:center;}"
a+="@media (max-width:360px){.mxTatamiGlobalBoxDiv{display:block;}"
a+=".mxTatamiGlobalBoxDiv div.mxGobanBoxDiv{padding:1px 0;}"
a+="}";
e.type='text/css';
...
(function(){var a="",e=document.createElement("style");
a+=".mxTatamiGlobalBoxDiv div.mxNavigationBoxDiv{background:#eee;padding:0.5em 0;}"
a+=".mxTatamiGlobalBoxDiv div.mxNavigationDiv{line-height:1.8em;margin:0 auto;text-align:center;display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center;-webkit-flex-wrap:wrap;flex-wrap:wrap;}"
a+=".mxTatamiGlobalBoxDiv div.mxNavigationDiv button{-webkit-flex:1 1 2em;flex:1 1 2em;padding:0.2em;min-width:2em;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv input{font-family:Arial,sans-serif;font-size:1em;width:2em;height:1em;vertical-align:middle;text-align:center;margin:0;border:1px solid #999;background:transparent;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv button div{display:block;position:relative;top:0;height:1em;width:0;margin:0 auto;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv button div span {display:none;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv button div:before,div.mxTatamiGlobalBoxDiv div.mxNavigationDiv button div:after{top:0;position:absolute;content:\"\";border-width:0;border-style:solid;border-color:transparent #000;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv button:focus div:before,div.mxTatamiGlobalBoxDiv div.mxNavigationDiv button:focus div:after{border-color:transparent #f00;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv button[disabled] div:before,div.mxTatamiGlobalBoxDiv div.mxNavigationDiv button[disabled] div:after{border-color:transparent #999;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv .mxFirstBtn div:before{height:1em;left:-0.3125em;border-width:0 0 0 0.125em;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv .mxFirstBtn div:after{height:0;right:-0.3125em;border-width:0.5em 0.5em 0.5em 0; }"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv .mxTenPredBtn div:before{height:0;left:-0.5em;border-width:0.5em 0.5em 0.5em 0; }"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv .mxTenPredBtn div:after{height:0;right:-0.5em;border-width:0.5em 0.5em 0.5em 0; }"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv .mxPredBtn div:after{height:0;left:-0.25em;border-width:0.5em 0.5em 0.5em 0; }"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv .mxNextBtn div:before{height:0;left:-0.25em;border-width:0.5em 0 0.5em 0.5em;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv .mxTenNextBtn div:before{height:0;left:-0.5em;border-width:0.5em 0 0.5em 0.5em;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv .mxTenNextBtn div:after{height:0;right:-0.5em;border-width:0.5em 0 0.5em 0.5em;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv .mxLastBtn div:before{height:0;left:-0.3125em;border-width:0.5em 0 0.5em 0.5em;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv .mxLastBtn div:after{height:1em;right:-0.3125em;border-width:0 0.125em 0 0;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv .mxLoopBtn div:before{height:0;left:-0.625em;border-width:0.5em 0.5em 0.5em 0; }"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv .mxLoopBtn div:after{height:0;right:-0.625em;border-width:0.5em 0 0.5em 0.5em;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv .mxPauseBtn div:before{height:1em;left:0.25em;border-width:0 0 0 0.125em;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv .mxPauseBtn div:after{height:1em;right:0.25em;border-width:0 0.125em 0 0;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv button::-moz-focus-inner {padding:0;border:0;}"
a+="div.mxTatamiGlobalBoxDiv div.mxNavigationDiv{-khtml-user-select: none;-webkit-user-select: none;-moz-user-select: -moz-none;-ms-user-select: none;user-select: none;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
(function(){var a="",e=document.createElement("style");
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxTopBoxDiv,.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxSpeedBoxDiv,.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxGotoBoxDiv,.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxButtonBoxDiv{background:#eee;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxTopBoxDiv{padding:0.5em;text-align:center;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxSpeedBoxDiv{padding:0.25em 0;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxGotoBoxDiv{padding:0.25em 0;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxButtonBoxDiv{padding:0.5em 0;text-align:center;line-height:2em;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv h1{color:#000;margin:0;text-align:center;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv h1.mxTitleH1{font-size:1.4em;padding:0;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv h1.mxTitleH1 span.mxROTitleSpan {white-space:nowrap;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowOptionDiv h1{font-size:1em;padding:0.5em 0.5em 0 0.5em;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowSgfDiv,.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowOptionDiv,.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowHeaderDiv{color:#000;background:#fff;cursor:default;white-space:normal;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowContentDiv{position:absolute;left:0;top:0;right:0;bottom:3.4em;overflow:auto;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxOKDiv{text-align:center;position:absolute;left:0;right:0;bottom:0;background:#eee;padding-top:0.5em;padding-bottom:0.5em;height:2.4em;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowHeaderDiv div.mxP{text-align:justify;line-height:1.4em;padding:0.5em;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowOptionDiv div.mxP{text-align:left;line-height:1.4em;padding:0.5em;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowSgfDiv div.mxP{text-align:left;font-family:monospace;padding:0.5em;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv.mxIn3d div.mxShowSgfDiv,.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv.mxIn3d div.mxShowOptionDiv,.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv.mxIn3d div.mxShowHeaderDiv,.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv.mxIn3d div.mxPlayerDiv{box-shadow: 0em 0.1em 0.1em #963;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv.mxIn2d div.mxShowSgfDiv,.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv.mxIn2d div.mxShowOptionDiv,.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv.mxIn2d div.mxShowHeaderDiv,.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv.mxIn2d div.mxPlayerDiv{border:1px solid #dfc997;box-shadow:1px 0 0.5em #dfc997;box-shadow:-1px 0 0.5em #dfc997;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxButtonBoxDiv > div{text-align:center;display:inline-block;vertical-align:top;padding:0;}"
a+="/* buttons */.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowOptionDiv input[type=text]{text-align:center;width:2em;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowOptionDiv input.mxLoopTimeTextInput,.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowOptionDiv input.mxAnimatedStoneTimeTextInput{width:3em;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxPassDiv button.mxJustPlayedPassBtn{color:#fff;background-color:#f00;font-weight:normal;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxPassDiv button.mxOnVariationPassBtn{color:#000;background-color:#fff;font-weight:bold;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxPassDiv button.mxOnFocusPassBtn{color:#f00;background-color:#fff;font-weight:bold;}"
a+="/* others */.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv .mxSpeedDiv {text-align:center;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv .mxSpeedDiv .mxSpeedBarDiv {cursor:pointer;display:inline-block;vertical-align:middle;margin:0 0.25em;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv .mxSpeedDiv .mxSpeedPlusBtn,.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv .mxSpeedDiv .mxSpeedMinusBtn{font-size:1em;border:0;margin:0;padding:0;width:1em;height:1.5em;vertical-align:middle;background:transparent;box-shadow:none;text-align:center;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv .mxSpeedDiv .mxSpeedBarDiv {border:1px solid #999;background-color:#fff;height:0.5em;width:60%;margin:0;vertical-align:middle;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv .mxSpeedDiv .mxSpeedBarDiv canvas {border:1px solid #999;background-color:#fff;height:1em;width:0.5em;top:-0.25em;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxGotoDiv {height:0.75em;width:60%;background:#fff;margin:0 auto;outline:1px solid #999;cursor:pointer;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxGotoDiv canvas {height:0.75em;width:0.75em;background:#000;cursor:pointer;}"
a+="/* Players */.mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxPlayerDiv{display:inline-block;text-align:center;color:#000;background-color:#fff;white-space:normal;max-width:16em;padding:0.5em;margin:0.5em auto;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxPlayerDiv:first-of-type{margin-bottom:0;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv div.mxPlayerDiv:last-of-type{margin-top:0;}"
a+=".mxTatamiGlobalBoxDiv.mxGameGlobalBoxDiv .mxCircleSpan {vertical-align:0.05em;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].b[0]={n:"TopBox",c:["Title"]};
mxG.D[mxG.K].b[1]={n:"GobanBox",c:["Diagram","TatamiCartouche","TatamiWhite","Goban","AnimatedStone","TatamiBlack","Variations"]};
mxG.D[mxG.K].b[2]={n:"NavigationBox",c:["Navigation","Loop"]};
mxG.D[mxG.K].b[3]={n:"SpeedBox",c:["Speed"]};
mxG.D[mxG.K].b[4]={n:"GotoBox",c:["Goto"]};
mxG.D[mxG.K].b[5]={n:"ButtonBox",c:["Option","Cut","Pass","Header","Sgf"]};
mxG.D[mxG.K].b[6]={n:"VersionBox",c:["Version"]};
...
mxG.D[mxG.K].variationOnFocusFontWeight="normal";
mxG.D[mxG.K].variationOnFocusColor="#f00";
mxG.D[mxG.K].maximizeGobanWidth=1;
mxG.D[mxG.K].adjustNavigationWidth=1;
mxG.D[mxG.K].headerBtnOn=1;
mxG.D[mxG.K].sgfBtnOn=1;
mxG.D[mxG.K].optionBtnOn=1;
mxG.D[mxG.K].titleBoxOn=1;
mxG.D[mxG.K].gotoBoxOn=1;
mxG.D[mxG.K].headerLabel_en="More";
mxG.D[mxG.K].headerLabel_fr="R&eacute;sum&eacute;";
mxG.D[mxG.K].canPlaceVariation=1;
mxG.D[mxG.K].hideTitle=1;
mxG.D[mxG.K].hideEmptyTitle=1;
mxG.D[mxG.K].hideEmptyPlayer=1;
mxG.D[mxG.K].translateTitleOn=1;
mxG.D[mxG.K].hideIndicesOn=0;
...
mxG.D[mxG.K].showHideBowlsAndPlayersOn=1;
