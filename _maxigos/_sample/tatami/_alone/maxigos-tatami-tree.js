...
(function(){var a="",e=document.createElement("style");
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxCommentBoxDiv,.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxTreeBoxDiv,.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxButtonBoxDiv{background:#eee;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxCommentDiv[data-maxigos-disabled],.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxTreeDiv[data-maxigos-disabled] {opacity:0.3;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxCommentBoxDiv{padding:0 0 0.5em 0;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxTreeBoxDiv{padding:0;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxButtonBoxDiv{padding:0.5em 0;text-align:center;line-height:2em;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv h1{color:#000;font-size:1em;text-align:center;margin:0;padding:0.5em 0.5em 0 0.5em;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv h1.mxTitleH1 span.mxROTitleSpan {white-space:nowrap;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowSgfDiv,.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowOptionDiv,.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowHeaderDiv{color:#000;background:#fff;cursor:default;white-space:normal;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowContentDiv{position:absolute;left:0;top:0;right:0;bottom:3.4em;overflow:auto;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxOKDiv{text-align:center;position:absolute;left:0;right:0;bottom:0;background:#eee;padding-top:0.5em;padding-bottom:0.5em;height:2.4em;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowHeaderDiv div.mxP{text-align:justify;line-height:1.4em;padding:0.5em;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowOptionDiv div.mxP{text-align:left;line-height:1.4em;padding:0.5em;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowSgfDiv div.mxP{text-align:left;font-family:monospace;line-height:normal;padding:0.5em;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv.mxIn3d div.mxShowSgfDiv,.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv.mxIn3d div.mxShowOptionDiv,.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv.mxIn3d div.mxShowHeaderDiv,.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv.mxIn3d div.mxPlayerDiv{box-shadow: 0em 0.1em 0.1em #963;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv.mxIn2d div.mxShowSgfDiv,.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv.mxIn2d div.mxShowOptionDiv,.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv.mxIn2d div.mxShowHeaderDiv,.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv.mxIn2d div.mxPlayerDiv{border:1px solid #dfc997;box-shadow:1px 0 0.5em #dfc997;box-shadow:-1px 0 0.5em #dfc997;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxButtonBoxDiv > div{text-align:center;display:inline-block;vertical-align:top;}"
a+="/* buttons */.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowOptionDiv input[type=text]{text-align:center;width:2em;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowOptionDiv input.mxLoopTimeTextInput,.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowOptionDiv input.mxAnimatedStoneTimeTextInput{width:3em;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxPassDiv button.mxJustPlayedPassBtn{color:#fff;background-color:#f00;font-weight:normal;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxPassDiv button.mxOnVariationPassBtn{color:#000;background-color:#fff;font-weight:bold;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxPassDiv button.mxOnFocusPassBtn{color:#f00;background-color:#fff;font-weight:bold;}"
a+="/* others */.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxCommentDiv,.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxTreeDiv{position:relative;margin:0 12px;overflow-x:auto;overflow-y:scroll;background:#fff;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxCommentDiv{height:6.75em;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxTreeDiv{height:7em;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv .mxCommentContentDiv{position:absolute;padding:0.5em;text-align:justify;line-height:1.25em;}"
a+="/* Players */.mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxPlayerDiv{display:inline-block;text-align:center;color:#000;background-color:#fff;white-space:normal;max-width:16em;padding:0.5em;margin:0.5em auto;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxPlayerDiv:first-of-type{margin-bottom:0;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxPlayerDiv:last-of-type{margin-top:0;}"
a+=".mxTatamiGlobalBoxDiv.mxTreeGlobalBoxDiv .mxCircleSpan {vertical-align:0.05em;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].b[0]={n:"GobanBox",c:["Diagram","TatamiCartouche","TatamiWhite","Goban","AnimatedStone","TatamiBlack","Variations"]};
mxG.D[mxG.K].b[1]={n:"NavigationBox",c:["Navigation"]};
mxG.D[mxG.K].b[2]={n:"CommentBox",c:["Comment"]};
mxG.D[mxG.K].b[3]={n:"TreeBox",c:["Tree"]};
mxG.D[mxG.K].b[4]={n:"ButtonBox",c:["Option","Cut","Pass","Header","Sgf"]};
mxG.D[mxG.K].b[5]={n:"VersionBox",c:["Version"]};
