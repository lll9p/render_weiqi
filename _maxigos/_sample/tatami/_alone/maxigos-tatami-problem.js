...
(function(){var a="",e=document.createElement("style");
a+=".mxTatamiGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveBoxDiv,.mxTatamiGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxCommentBoxDiv{background:#eee;padding:0.5em;}"
a+=".mxTatamiGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv{margin:0 auto;text-align:center;line-height:2em;}"
a+=".mxTatamiGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxCommentDiv {text-align:center;min-height:1.8em;margin:0 auto;}"
a+=".mxTatamiGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxCommentContentDiv {display:inline-block;text-align:justify;padding:0.25em;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].b[1]={n:"GobanBox",c:["Diagram","TatamiCartouche","TatamiWhite","Goban","AnimatedStone","TatamiBlack"]};
...
mxG.D[mxG.K].variationBk="#bc8e39";
mxG.D[mxG.K].variationOnFocusBk="#a74";
