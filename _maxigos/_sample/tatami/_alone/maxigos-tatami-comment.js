...
(function(){var a="",e=document.createElement("style");
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxCommentBoxDiv,.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxButtonBoxDiv{background:#eee;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxCommentDiv[data-maxigos-disabled] {opacity:0.3;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxCommentBoxDiv{padding:0;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxButtonBoxDiv{padding:0.5em;text-align:center;line-height:2em;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv h1{color:#000;font-size:1em;text-align:center;margin:0;padding:0.5em 0.5em 0 0.5em;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv h1.mxTitleH1 span.mxROTitleSpan {white-space:nowrap;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowSgfDiv,.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowOptionDiv,.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowHeaderDiv{color:#000;background:#fff;cursor:default;white-space:normal;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowContentDiv{position:absolute;left:0;top:0;right:0;bottom:3.4em;overflow:auto;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxOKDiv{text-align:center;position:absolute;left:0;right:0;bottom:0;background:#eee;padding-top:0.5em;padding-bottom:0.5em;height:2.4em;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowHeaderDiv div.mxP{text-align:justify;line-height:1.4em;padding:0.5em;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowOptionDiv div.mxP{text-align:left;line-height:1.4em;padding:0.5em;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowSgfDiv div.mxP{text-align:left;font-family:monospace;line-height:normal;padding:0.5em;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv.mxIn3d div.mxShowSgfDiv,.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv.mxIn3d div.mxShowOptionDiv,.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv.mxIn3d div.mxShowHeaderDiv,.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv.mxIn3d div.mxPlayerDiv{box-shadow: 0em 0.1em 0.1em #963;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv.mxIn2d div.mxShowSgfDiv,.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv.mxIn2d div.mxShowOptionDiv,.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv.mxIn2d div.mxShowHeaderDiv,.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv.mxIn2d div.mxPlayerDiv{border:1px solid #dfc997;box-shadow:1px 0 0.5em #dfc997;box-shadow:-1px 0 0.5em #dfc997;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxButtonBoxDiv > div{text-align:center;display:inline-block;vertical-align:top;}"
a+="/* buttons */.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowOptionDiv input[type=text]{text-align:center;width:2em;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowOptionDiv input.mxLoopTimeTextInput,.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowOptionDiv input.mxAnimatedStoneTimeTextInput{width:3em;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxPassDiv button.mxJustPlayedPassBtn{color:#fff;background-color:#f00;font-weight:normal;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxPassDiv button.mxOnVariationPassBtn{color:#000;background-color:#fff;font-weight:bold;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxPassDiv button.mxOnFocusPassBtn{color:#f00;background-color:#fff;font-weight:bold;}"
a+="/* others */.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxCommentDiv{height:6.75em;position:relative;margin:0 12px;overflow-x:auto;overflow-y:scroll;background:#fff;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv .mxCommentContentDiv{position:absolute;padding:0.5em;line-height:1.25em;text-align:justify;}"
a+="/* Players */.mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxPlayerDiv{display:inline-block;text-align:center;color:#000;background-color:#fff;white-space:normal;max-width:16em;padding:0.5em;margin:0.5em auto;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxPlayerDiv:first-of-type{margin-bottom:0;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxPlayerDiv:last-of-type{margin-top:0;}"
a+=".mxTatamiGlobalBoxDiv.mxCommentGlobalBoxDiv .mxCircleSpan {vertical-align:0.05em;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].b[3]={n:"ButtonBox",c:["Option","Cut","Pass","Header","Sgf"]};
mxG.D[mxG.K].b[4]={n:"VersionBox",c:["Version"]};
