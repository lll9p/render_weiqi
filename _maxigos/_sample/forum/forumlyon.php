...
else if ($mxL=="ja") $title2="forum.jeudego.orgスタイル";
...
.content1 {background-color:#f5e8e7;}
.content2 {background-color:#efd8d9;}
h1.header
{
	margin:0 0.5em 0.25em 0.5em;padding:1em;font-size:1em;
	background:linear-gradient(to top,#b6120d,#810400);
	color:#fff;
	font-weight:bold;
...
<script data-maxigos-sgf="<?php print "../_sgf/game/mn-bdg-".(($mxL=="fr")?"fr":"en").".sgf";?>"
        src="../../_mgos/sgfplayer.php?mxL=<?php print $mxL;?>&amp;cfg=<?php print urlencode("../_sample/forum/commentairelyon.cfg");?>"></script>
</div>
