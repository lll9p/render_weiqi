...
if (isset($_GET["id"]))
{
	...
	else if ($_GET["id"]==114) $file="../../_sgf/game/blood-vomit-zh.sgf";
	else if ($_GET["id"]==115) $file="../../_sgf/game/blood-vomit-zh-tw.sgf";
	...
	else if ($_GET["id"]==154) $file="../../_sgf/game/Mingren-001-1F-1-zh.sgf";
	else if ($_GET["id"]==155) $file="../../_sgf/game/Mingren-001-1F-1-zh-tw.sgf";
	...
	else if ($_GET["id"]==414) $file="../../_sgf/problem/p1-zh.sgf";
	else if ($_GET["id"]==415) $file="../../_sgf/problem/p1-zh-tw.sgf";
	...
	else if ($_GET["id"]==424) $file="../../_sgf/problem/p2-zh.sgf";
	else if ($_GET["id"]==425) $file="../../_sgf/problem/p2-zh-tw.sgf";
	...
	else if ($_GET["id"]==434) $file="../../_sgf/problem/p3-zh.sgf";
	else if ($_GET["id"]==435) $file="../../_sgf/problem/p3-zh-tw.sgf";
	...
	else if ($_GET["id"]==494) $file="../../_sgf/problem/tactigo-zh.sgf";
	else if ($_GET["id"]==495) $file="../../_sgf/problem/tactigo-zh-tw.sgf";
