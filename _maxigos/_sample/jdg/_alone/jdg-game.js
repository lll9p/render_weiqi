...
a+=".mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowHeaderDiv,.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowSgfDiv,.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowOptionDiv{z-index:10;background-color:white;cursor:default;white-space:normal;}"
a+=".mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowContentDiv{position:absolute;left:0;top:0;right:0;bottom:2.5em;overflow:auto;}"
...
a+=".mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowHeaderDiv div.mxP,.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowOptionDiv div.mxP{line-height:1.4em;padding:0.5em;}"
a+=".mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowSgfDiv div.mxP{line-height:normal;text-align:left;font-family:monospace;padding:0.5em;}"
...
a+=".mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowOptionDiv h1{text-align:center;}"
a+=".mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowSgfDiv,.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowOptionDiv,.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxShowHeaderDiv,.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxPlayerDiv{box-shadow: 0em 0.1em 0.1em #963;}"
a+=".mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxNavigationBoxDiv{padding:0.5em 0;}"
a+=".mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxButtonBoxDiv{padding:0.25em 0 0.5em 0;line-height:2em;text-align:center;}"
a+=".mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxButtonBoxDiv > div{text-align:center;display:inline-block;vertical-align:top;padding:0;}"
a+="/* others */.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxPlayerDiv{text-align:center;margin:0.5em auto;padding:0.5em;color:#000;background-color:#fff;max-width:16em;white-space:normal;}"
...
a+="/* pass */.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxPassDiv  button.mxOnVariationPassBtn{color:#fff;background:#495257;border-color:#495257;}"
a+=".mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxPassDiv  button.mxOnFocusPassBtn,.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxPassDiv  button.mxOnFocusAndOnVariationPassBtn{color:#fff;background:crimson;border-color:crimson;}"
a+="/* others */.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxGotoDiv {width:80%;height:0.75em;background:#fff;margin:0 auto 0.5em auto;outline:1px solid #fb2;cursor:pointer;}"
...
a+="/* version */.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxVersionBoxDiv{position:relative;}"
a+=".mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxVersionDiv{font-size:0.75em;color:#999;padding:0 0.25em;position:absolute;bottom:0;right:0;    -webkit-transform-origin:right bottom;    -moz-transform-origin:right bottom;    -ms-transform-origin:right bottom;    -o-transform-origin:right bottom;transform-origin:right bottom;    -webkit-transform:rotate(90deg);    -moz-transform:rotate(90deg);    -ms-transform:rotate(90deg);    -o-transform:rotate(90deg);transform:rotate(90deg);}"
a+="@media (max-width:45em){.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxGobanBoxDiv{padding:1px 0.25em;}"
...
a+=".mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxVersionDiv{position:relative;text-align:center;-webkit-transform-origin:none;-moz-transform-origin:none;-ms-transform-origin:none;-o-transform-origin:none;transform-origin:none;-webkit-transform:none;-moz-transform:none;-ms-transform:none;-o-transform:none;transform:none;}"
a+="}@media (max-height:45em){.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxPlayerDiv{display:none;}"
a+="}@media (max-width:45em) and (max-height:45em){.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxVersionDiv{display:none;}"
a+="}@media (max-width:23em){.mxJdgGlobalBoxDiv.mxGameGlobalBoxDiv div.mxGobanBoxDiv{padding:1px 0;}"
a+="}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
...
mxG.D[mxG.K].b[0]={n:"GobanBox",c:["Title","TatamiCartouche","TatamiWhite","Goban","TatamiBlack","Diagram","Variations","AnimatedStone"]};
mxG.D[mxG.K].b[1]={n:"VersionBox",c:["Version"]};
mxG.D[mxG.K].b[2]={n:"NavigationBox",c:["Navigation","Loop"]};
mxG.D[mxG.K].b[3]={n:"GotoBox",c:["Goto"]};
mxG.D[mxG.K].b[4]={n:"SpeedBox",c:["Speed"]};
mxG.D[mxG.K].b[5]={n:"ButtonBox",c:["Option","Cut","Pass","Header","Kifu","Image","Sgf"]};
mxG.D[mxG.K].b[6]={n:"GuessBox",c:["Guess"]};
