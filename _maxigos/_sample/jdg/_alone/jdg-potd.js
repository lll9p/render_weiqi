...
(function(){var a="",e=document.createElement("style");
a+="div.mxJdgGlobalBoxDiv.mxPotdGlobalBoxDiv div.mxGobanDiv {margin:0 auto;}"
a+="div.mxJdgGlobalBoxDiv.mxPotdGlobalBoxDiv.mxIn3d div.mxGobanDiv {padding:0 4px 4px 0;}"
a+="div.mxJdgGlobalBoxDiv.mxPotdGlobalBoxDiv div.mxGobanDiv canvas{color:#000;background-color:#fcba54;font-size:0.9375em;}"
a+="div.mxJdgGlobalBoxDiv.mxPotdGlobalBoxDiv.mxIn3d div.mxInnerGobanDiv{box-shadow:1px 1px #965400,2px 2px #965400,3px 3px #965400,4px 4px #965400,   8px 8px 8px rgba(0,0,0,0.3);}"
a+="div.mxJdgGlobalBoxDiv.mxPotdGlobalBoxDiv div.mxCommentDiv{/* can display 2 lines of comment with goban remaining at the same place */min-height:3.5em;line-height:3.5em;text-align:center;margin:0 auto;}"
a+="div.mxJdgGlobalBoxDiv.mxPotdGlobalBoxDiv div.mxCommentContentDiv{display:inline-block;line-height:normal;text-align:justify;padding:0.125em;}"
a+="div.mxJdgGlobalBoxDiv.mxPotdGlobalBoxDiv div.mxSolveDiv {padding-top:0.5em;text-align:center;margin:0 auto;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].config="Potd";
mxG.D[mxG.K].b[0]={n:"Box",c:["Comment","Diagram","Goban","AnimatedStone","Solve"]};
...
mxG.D[mxG.K].fitMax=12;
mxG.D[mxG.K].initialMessage_fr="À Noir de jouer !";
mxG.D[mxG.K].nowhereMessage_fr="Hum !";
mxG.D[mxG.K].successMessage_fr="Bravo !";
mxG.D[mxG.K].failMessage_fr="Raté !";
