...
{
if (this.adjustLessonWidth) this.adjust("Lesson","Width");
if (this.adjustLessonHeight) this.adjust("Lesson","Height");
};
...
mxG.D[mxG.K].b[0]={n:"2Box",c:["Lesson","Speed"]};
mxG.D[mxG.K].b[1]={n:"1Box",c:["Diagram","Goban","Navigation","Loop","Variations"]};
mxG.D[mxG.K].b[2]={n:"3Box",c:["Version"]};
mxG.D[mxG.K].markOnLastOn=1;
mxG.D[mxG.K].numAsMarkOnLastOn=1;
...
mxG.D[mxG.K].adjustLessonHeight=1;
mxG.D[mxG.K].adjustSpeedBarWidth=1;
