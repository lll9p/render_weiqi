...
a+="div.mxMinimalistGlobalBoxDiv div.mxNavigationDiv button{font-size:1em;width:2em;height:1em;background-color:transparent;background-image:none;box-shadow:none;border:0;padding:0;margin:0 0.5em;vertical-align:middle;}"
a+="div.mxMinimalistGlobalBoxDiv div.mxNavigationDiv input{font-family:Arial,sans-serif;font-size:1em;width:2em;height:1em;vertical-align:middle;text-align:center;margin:0;border:1px solid #999;background:transparent;}"
...
(function(){var a="",e=document.createElement("style");
a+="div.mxMinimalistGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxCommentDiv{margin:0.5em auto;height:8em;overflow:auto;border:1px solid #999;}"
a+="div.mxMinimalistGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxCommentContentDiv {padding:0.25em;text-align:justify;}"
a+="div.mxMinimalistGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxCommentDiv h1 {font-size:1em;text-align:left;margin:0;}"
a+="div.mxMinimalistGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxTreeDiv{margin:0.5em auto;padding:0.25em;height:8em;overflow:auto;border:1px solid #999;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
