...
(function(){var a="",e=document.createElement("style");
a+="div.mxMinimalistGlobalBoxDiv.mxDiagramGlobalBoxDiv div.mxNotSeenDiv {text-align:left;margin:0.5em auto;}"
a+="div.mxMinimalistGlobalBoxDiv.mxDiagramGlobalBoxDiv div.mxInNotSeenDiv{white-space:nowrap;display:inline-block;padding:0.1em;}"
a+="div.mxMinimalistGlobalBoxDiv.mxDiagramGlobalBoxDiv div.mxInNotSeenDiv * {vertical-align:middle;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
