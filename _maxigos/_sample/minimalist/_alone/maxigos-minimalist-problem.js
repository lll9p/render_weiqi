...
(function(){var a="",e=document.createElement("style");
a+="div.mxMinimalistGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxCommentDiv {margin:0 auto;text-align:center;}"
a+="div.mxMinimalistGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxCommentContentDiv {display:inline-block;text-align:justify;}"
a+="div.mxMinimalistGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv {text-align:center;margin:0.5em auto;}"
a+="div.mxMinimalistGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv button{font-family:Arial,sans-serif;font-size:0.875em;height:auto;border:1px solid #000;margin:1px;padding:0.25em;color:#000;background:transparent;box-shadow:none;}"
a+="div.mxMinimalistGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv button[disabled] {border:1px solid #999;color:#999;}"
a+="div.mxMinimalistGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv button:hover {cursor:pointer;}"
a+="div.mxMinimalistGlobalBoxDiv.mxProblemGlobalBoxDiv div.mxSolveDiv button[disabled]:hover {cursor:default;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].b[0]={n:"Box",c:["Diagram","Goban","Solve","Comment"]};
