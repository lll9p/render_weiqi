...
(function(){var a="",e=document.createElement("style");
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxCommentDiv{margin:0.5em auto;height:7em;overflow:auto;border:1px solid #999;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxCommentDiv[data-maxigos-disabled] {opacity:0.3;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxCommentContentDiv {padding:0.25em;text-align:justify;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxCommentDiv h1 {font-size:1em;text-align:left;margin:0;padding:0;border:0;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxButtonsBoxDiv {text-align:center;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxOptionDiv,div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxSgfDiv {display:inline-block;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxButtonsBoxDiv button,div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxOKDiv button{font-family:Arial,sans-serif;font-size:0.875em;height:auto;min-width:6em;border:1px solid #000;margin:1px;padding:0.125em 0.375em;color:#000;box-shadow:none;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxButtonsBoxDiv button{background:transparent;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxOKDiv button{background:#fff;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv input[type=text]{text-align:center;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowOptionDiv,div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowSgfDiv{background:#fff;border:1px solid #999;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowContentDiv{position:absolute;top:0;left:0;right:0;bottom:2.5em;overflow:auto;padding:0.5em;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowContentDiv h1{font-size:1.25em;margin:0;padding:0 0 0.5em 0;border:0;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxShowSgfDiv div.mxP{font-family:monospace;line-height:normal;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxCommentGlobalBoxDiv div.mxOKDiv{position:absolute;bottom:0;left:0;right:0;padding:0.5em;text-align:center;background:#eee;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].b[0]={n:"Box",c:["Diagram","Goban","Navigation","Goto","Variations","Title","Header","Comment"]};
mxG.D[mxG.K].b[1]={n:"ButtonsBox",c:["Option","Sgf"]};
