...
a+="div.mxNeoClassicGlobalBoxDiv div.mxVersionDiv {text-align:center;margin-top:0.5em;}";
e.type='text/css';
...
(function(){var a="",e=document.createElement("style");
a+="div.mxNeoClassicGlobalBoxDiv div.mxNavigationDiv{margin:0 auto;padding:0.5rem 0 0.25rem 0;text-align:center;line-height:0;}"
a+="div.mxNeoClassicGlobalBoxDiv div.mxNavigationDiv button{font-size:1em;width:2em;height:1em;background-color:transparent;background-image:none;box-shadow:none;border:0;padding:0;margin:0 0.5em;vertical-align:middle;}"
a+="div.mxNeoClassicGlobalBoxDiv div.mxNavigationDiv input{font-family:Arial,sans-serif;font-size:0.75em;width:2em;height:1em;vertical-align:middle;text-align:center;margin:0;border:1px solid #999;background:transparent;}"
...
(function(){var a="",e=document.createElement("style");
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxCommentDiv{margin:0.5em auto;height:7em;overflow:auto;border:1px solid #999;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxCommentDiv[data-maxigos-disabled] {opacity:0.3;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxCommentContentDiv {padding:0.25em;text-align:justify;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxCommentDiv h1 {font-size:1em;text-align:left;margin:0;padding:0;border:0;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxTreeDiv{margin:0.5em auto;padding:0.25em;height:7em;overflow:auto;border:1px solid #999;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxTreeDiv[data-maxigos-disabled] {opacity:0.3;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxButtonsBoxDiv {text-align:center;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxOptionDiv,div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxSgfDiv {display:inline-block;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxButtonsBoxDiv button,div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxOKDiv button{font-family:Arial,sans-serif;font-size:0.875em;height:auto;min-width:6em;border:1px solid #000;margin:1px;padding:0.125em 0.375em;color:#000;background:#fff;box-shadow:none;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxButtonsBoxDiv button{background:transparent;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxOKDiv button{background:#fff;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv input[type=text]{text-align:center;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowOptionDiv,div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowSgfDiv{position:relative;border:1px solid #999;background:#fff;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowContentDiv{position:absolute;top:0;left:0;right:0;bottom:2.5em;overflow:auto;padding:0.5em;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowContentDiv h1{font-size:1.25em;margin:0;padding:0 0 0.5em 0;border:0;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxShowSgfDiv div.mxP{font-family:monospace;line-height:normal;}"
a+="div.mxNeoClassicGlobalBoxDiv.mxTreeGlobalBoxDiv div.mxOKDiv{position:absolute;bottom:0;left:0;right:0;padding:0.5em;text-align:center;background:#eee;}";
e.type='text/css';
if (e.styleSheet) e.styleSheet.cssText=a;
else e.appendChild(document.createTextNode(a));
document.getElementsByTagName('head')[0].appendChild(e);
...
mxG.D[mxG.K].b[0]={n:"1Box",c:["Diagram","Goban","Navigation","Goto","Variations"]};
mxG.D[mxG.K].b[1]={n:"2Box",c:["Title","Header","Comment"]};
mxG.D[mxG.K].b[2]={n:"3Box",c:["Tree"]};
mxG.D[mxG.K].b[3]={n:"ButtonsBox",c:["Option","Sgf"]};
